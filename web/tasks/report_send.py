...
class ReportSenderTask (object):
    ...
    def report_manager(interval):
        ...
        for key in report_stack:
            print key
            self.report_generate.delay(key)
    ...
    @staticmethod
    def _get_person(report_stack, firm):
